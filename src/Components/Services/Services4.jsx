...
const Services = () => {
    const services = [
        ...
        { icon: <i className="fas fa-plug"></i>, title: "Third party API integrations", route: "/business" },
        { icon: <i className="fas fa-project-diagram"></i>, title: "Management Systems", route: "/business" },
